...
export default function CreateProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Form submited"); // Show success message
    } catch (error) {
  ...
  return (
    <div className="bg-pink-700 ">
      ...
      <div className="container mx-auto p-8 bg-pink-900 shadow-lg rounded-lg ">
        <form ref={formRef} onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <div className="flex justify-center mt-6 mb-6">
            <button type="submit" className="bg-pink-600 text-white py-2 px-6 rounded-lg hover:bg-pink-700">
              Submit
            </button>
          </div>
        </form>
