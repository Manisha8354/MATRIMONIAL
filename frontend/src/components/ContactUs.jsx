    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center bg-gray-100 p-6 ">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:w-3/4 bg-pink-900 p-8 rounded-lg shadow-lg">
          <form method="post">
      {/* Name Field */}
      <div className="mb-6">
      ...
      <div className="text-center">
        <button
          className="bg-pink-500 text-white px-6 py-3 rounded-lg hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:ring-opacity-50 transition duration-300 ease-in-out"
          type="submit"
