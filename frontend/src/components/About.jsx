...
export default function About() {
  ...
  <div className="relative w-full  h-60 sm:h-72 md:h-96 lg:h-[500px] xl:h-[600px] bg-cover bg-center" style={{ backgroundImage: 'url(https://img.freepik.com/premium-photo/indian-wedding-saath-phere-bride-groom-holding-hands_898049-171.jpg)' }}>
  {/* Content to overlap */}
  ...
  <div className="flex flex-col md:flex-row items-center justify-center p-6 bg-gray-100">
    ...
    <div className="md:w-1/2 p-4">
      <img
        ...
        src="https://getethnic.com/wp-content/uploads/2020/10/Matching-Bridal-Lehenga-and-Groom-Sherwani-1.jpeg"
        alt="About Us"
      />
    </div>
  </div>
