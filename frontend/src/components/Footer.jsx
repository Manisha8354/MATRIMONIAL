...
<footer className="bg-cover relative bottom-0 bg-center text-white py-4" style={{ backgroundImage: "url('https://www.pixelstalk.net/wp-content/uploads/2016/04/Pink-wallpapers-HD-free-download.jpg')" }}>
